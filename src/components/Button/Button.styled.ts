...
export const buttonVariantPrimary = tw`ring-blue-300 bg-blue-500 text-blue-500 border-blue-500`;
export const buttonVariantSuccess = tw`ring-green-300 bg-green-500 text-green-500 border-green-500`;
export const buttonVariantError = tw`ring-red-300 bg-red-500 text-red-500 border-red-500`;
export const buttonVariantWarning = tw`ring-yellow-300 bg-yellow-500 text-yellow-500 border-yellow-500`;
export const buttonVariantInfo = tw`ring-yellow-300 bg-yellow-500 text-yellow-500 border-yellow-500`;
